 ...
 * 									MISSING JOURNAL
 *
 * Long story short, BW win the Internal Battle against Semut Subuh
 * winning by points alone (BW -1 vs Semut Subuh -5)
 ...
 *			1. BW with forklift mechanism
 *			2. BW with planar arm mechanism
 *			3. BW without arm mechanism (USED)
 ...
 *		Fabricating new tibia design from aluminium
 *
 *  ===BW 2016 MAIN CONTROLLER BOARD TROUBLESHOOTING===
 *  TESTED SO FAR...
 *  Hexapod Servo
 ...
 * =============================================================================================
 * PROJECT BW 2016 - JUARA REGIONAL! LOLOS NASIONAL! JUARA NASIONAL!
 *
 *
 * PROGRESS SO FAR...
 * SOFTWARES:
 ...
 * PROGRESS SO FAR...
 * SOFTWARES:
 * 				BW NAVIGATION ALL ROUTE (MINUS ALL ROOM TO HALLWAY_SC)
 * 				BW FOLLOWHOME
 * 				BW STRATEGY BEHAVIOUR BASED SYSTEM ON ARBITRARY START
 * 				BW RETURN TRIP ALGORITHM
 *
 *
 * ELECTRONICS:
 ...
 * SOFTWARES:
 * 				BW Trial algorithm
 * 				BW home = Room 2, FIRE = Room 1, extinguish fire, and return trip
 * 				Fixing bugs in navigation (Room 2 <-> Room 1)
 * 				BW FireFight Algorithm
 ...
 * 					BW_FireFight routine kadang error
