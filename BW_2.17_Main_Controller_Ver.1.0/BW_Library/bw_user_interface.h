...
#define BW_BUTTON_INPUT GPIO_ReadInputDataBit(GPIOA, GPIO_Pin_1)
#define BW_BUTTON_CLICKED GPIO_ReadInputDataBit(GPIOA, GPIO_Pin_1)==1
#define BW_BUTTON_UNCLICKED   GPIO_ReadInputDataBit(GPIOA, GPIO_Pin_1)==0
